...
public class ServiceReminderService {
    ...
    public Optional<ServiceReminder> updateServiceReminder(Integer id, ServiceReminder serviceReminderDetails) {
        return serviceReminderRepository.findById(id).map(serviceReminder -> {
            ...
            serviceReminder.setWatchers(serviceReminderDetails.getWatchers());
